// components/seo/CategorySeoSettingsForm.tsx
"use client";
...
function LabeledTextarea({
  ...
  return (
    <div>
      ...
      <textarea
        className="w-full min-h={[100]} text-black rounded-lg border border-gray-200 bg-white px-3 py-2 focus:outline-none focus:ring-2 focus:ring-gray-300 disabled:opacity-60"
        placeholder={placeholder}
        value={value || ""}
        onChange={onChange}
        maxLength={max}
